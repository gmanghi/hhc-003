    ...
    return new Promise((resolve, reject) => {
        ...
        if(details.status == 'pending'){
            const mailOptions = {
                ...
                html: 'November 20, 2019<br /><br /><b>Client Name:</b>'+details.recipient_name+'<br /><b>Address:</b>'+details.recipient_address+'<br /><b>Contact number:</b>'+details.recipient_contact_number+'<br /><b>Email:</b>'+details.recipient_email+'<br /><br /><br /><b>Dear Ms/Mr. '+details.recipient_name+',</b><p>Home Health Care Placements, Inc. can deploy healthcare professionals (HCPs) for homecare andhospice for your love one, through our CareNET Unit, (Caregiver/Nurse Sourcing).</p><p>A Nurse Case Manager will be your point of contact to coordinate the needs of your love one. Weinvolve families in the Plan of Care in coordination with your Attending Physician.</p><p>Our staff are trained in long term care, are licensed HCPs with NBI and medical clearance.</p><p>Attached is the document of our deployment proposal.</p><p>Should you have any concerns, please feel free to get in touch with your Nurse Case Manager.</p><br /><br /><br />Sincerely,<br /><br /><br /><b>Nurse Case Manager:</b> '+details.nurse_case_manager+'<br /><b>Position:</b> '+details.position+'<br /><b>Contact Number:</b> '+details.contact_number+'',
                attachments: [ 
