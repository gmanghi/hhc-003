            ...
            <v-row>
                <v-col cols="12" sm="12" md="12">
                    <v-combobox
                        ...
                        label="Mini Nutritional Assessment Living Situation: Which of the following best describes the patient's residential circumstances and availability of assisstance?"
                        single    
                        chips
                    ></v-combobox>
                </v-col>
